...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/19 17:08:28 by aainhaja          #+#    #+#             */
/*   Updated: 2022/06/19 17:09:43 by aainhaja         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	checkexist(char *str, t_vars vars)
{
	...
	if (rec(vars))
		return (-1);
	if (ft_strchr(str, '0') == -1 || ft_strchr(str, 'C') == -1
		|| ft_strchr(str, 'E') == -1 || ft_strchr(str, 'P') == -1)
		return (-1);

...
/*   Updated: 2022/04/23 04:15:46 by aainhaja         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	vars.mlx = mlx_init();
	vars.win = mlx_new_window(vars.mlx, vars.width * TILESIZE, vars.height * TILESIZE, "Helwwlo world!");

	vars.win_img.img = mlx_new_image(vars.mlx, vars.width * TILESIZE , vars.height * TILESIZE);
	vars.win_img.addr = mlx_get_data_addr(vars.win_img.img, &vars.win_img.bits_per_pixel, &vars.win_img.line_length,
								&vars.win_img.endian);
